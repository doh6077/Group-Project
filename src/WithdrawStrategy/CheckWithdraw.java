...
*Provide methods to assess if withdrawal from a checking account is within the valid limit
...
public class CheckWithdraw implements WithdrawStrategy{
    ...
    *@param BankAccount account: checking account where money is withdrawn from
